...
import GSVGTexture exposing (svgTexture, SVGRequest)
...
getTexturesToLoad : Shape Never -> Shape Never -> Shape Never -> List SVGRequest
getTexturesToLoad topSh sidesSh bottomSh =
    [ svgTexture "skyT" TexColor topSh
    , svgTexture "skyB" TexColor bottomSh
    , svgTexture "skyS1" TexColor (sidesSh |> move (-75,0))
    , svgTexture "skyS2" TexColor (sidesSh |> move (-25,0))
    , svgTexture "skyS3" TexColor (sidesSh |> move (25,0))
    , svgTexture "skyS4" TexColor (sidesSh |> move (75,0))
    ]
